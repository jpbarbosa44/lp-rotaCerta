        ...
        <div className="flex h-screen">
            <div className="flex items-center justify-center p-8 bg-[#0c3f8c] flex-col w-[40%]">
                ...
                <p className='text-white mt-4'>
                    O RotaCerta é o aplicativo de GPS feito especialmente para caminhoneiros, oferecendo tudo o que você precisa para suas viagens de longa distância. Com funcionalidades avançadas e informações centralizadas, o RotaCerta torna suas rotas mais seguras, eficientes e tranquilas.
                </p>
            </div>
